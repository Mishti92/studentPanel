...
<a href="messages.php"><div id="page_nav_now">Inbox</div></a>
...
if(empty($messages))
{
echo 'There are no messages in your inbox';
}
else
{
	...
	<a href='delete_message.php?id=<?php echo $id; ?>'>Delete</a>
		</div>
		<?php
		}
		...
		{
		?>
		<div id="from_message_u">
		<?php 
			echo $sender;
			?>
		</div>
		<a href="view_message.php?id=<?php echo $id;?>">
		<div id="subject_message_u">
		<?php 
			echo $subject.'...';
			?>
		</div>
		</a>
		<div id="time_message_u">
			<?php 
			echo $date;
			?>
		</div>
		<div id="delete_message_u">
	<a href='delete_message.php?id=<?php echo $id; ?>'>Delete</a>
		</div>
		<?php
		}
