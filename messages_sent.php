...
<a href="messages_sent.php"><div id="page_nav_now">Sent</div></a>
...
<a href="view_sent_message.php?id=<?php echo $id;?>">
	...
	<a href='delete_sent_message.php?id=<?php echo $id; ?>'>Delete</a>
		</div>
