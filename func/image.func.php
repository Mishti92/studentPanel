...
function get_notes_images($album_id,$user_id)
{
  $album_id=(int)$album_id;
  $user_id=(int)$user_id;
  ...
  SELECT image_id, album_id, timestamp, ext
  FROM images
...
function image_check($image_id)  //we dont want other uses to see others images
{
